				...
				mCSB_draggerContainer.bind("click", function (e) {
					if ($this.data("horizontalScroll")) {
						...
						if (mouseCoord < mCSB_dragger.position().left || mouseCoord > (mCSB_dragger.position().left + mCSB_dragger.width())) {
							...
							//for centered dragger position
							//when not autoDraggerLength == false
							if (!$this.data("autoDraggerLength")){
								var halfDraggerWidth = mCSB_dragger.width() / 2;
								var scrollToPosCentered = mouseCoord - halfDraggerWidth ;

								if ( scrollToPosCentered < halfDraggerWidth )
									scrollToPosCentered = scrollToPos ;

								scrollToPos = scrollToPosCentered
							}
